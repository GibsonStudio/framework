...
function ini_events ()
{
	...
	document.getElementById('cursor_button').addEventListener('mousedown', function (e) { if (e.button ==0) { start_cursor_rotate(e); } });
	document.getElementById('front_center_button').addEventListener('mousedown', function (e) { if (e.button == 0) { start_face_rotate(e); } });
